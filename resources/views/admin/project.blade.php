				...
				<div class="card-body">
					<div class="dropdown dropdown-action profile-action">
						...
						<div class="dropdown-menu dropdown-menu-right">
							...
							<a class="dropdown-item" href="{{route('projectdelete',$allprojects->id)}}" onclick="return confirm('Are you sure you wish to permanently delete that project?')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
						</div>
					</div>
					<h4 class="project-title"><a href="{{route('projectview',$allprojects->id)}}">{{$allprojects->project_name}}</a></h4>             
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" id="addproject" action="{{route('createproject')}}" enctype="multipart/form-data">
						@csrf	
					   <div class="row">
							<div class="col-sm-6">
						...
						<!--<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<select class="form-control" name="addteam" id="addteam">
										<option value="">--</option>
										@foreach($getalluser as $getallusers)					
											<option value="{{$getallusers->uid}}">{{$getallusers->name}} {{$getallusers->last_name}}</option>
										@endforeach
									</select>	
									<span class="text-danger">{{$errors->first('addteam')}}</span>
								</div>
							</div>                              
						</div>-->
						<div class="row">
	...
	<div id="edit_project" class="modal custom-modal fade" role="dialog">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" id="editproject" action="{{route('updateproject')}}" enctype = "multipart/form-data">
						@csrf	
					   ...
					   <div class="row">
						...
						<!--<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label>Start Date</label>
									<input class="form-control" type="date" name="edit_startdate" id="edit_startdate">
									<span class="text-danger">{{$errors->first('edit_startdate')}}</span>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<label>Add Project Leader</label>
									<!--<input class="form-control" type="text" name="edit_projectlead" id="edit_projectlead">-->
						...
						<!--<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<select class="form-control" name="edit_addteam" id="edit_addteam">
										<option value="">--</option>
										@foreach($getalluser as $getallusers)
										<option value="{{$getallusers->uid}}">{{$getallusers->name}} {{$getallusers->last_name}}</option>
										@endforeach
									</select>
									<span class="text-danger">{{$errors->first('edit_addteam')}}</span>
								</div>
							</div>                              
						</div>-->
						<div class="row">
						...
						<div class="form-group">
							<label>Upload Files (optional)</label>
							<!--<img src="" id="images" width="200px;" height="200px;">	-->
