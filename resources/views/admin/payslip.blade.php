	...
	<div class="content container-fluid">
			...
			<div class="row align-items-center">
				...
				<div class="col-auto float-right ml-auto">
					<div class="btn-group btn-group-sm">
						...
						<a href="{{route('pdfconvert')}}" class="btn btn-white">PDF</a>
						<a class="btn btn-white print"><i class="fa fa-print fa-lg"></i> Print</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row" id="printpage">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h4 class="payslip-title">Payslip for the month of Aug 2021</h4>
						<div class="row">
							<div class="col-sm-6 m-b-20">
								<img src="./Payslip - HRMS admin template_files/logo2.png" class="inv-logo" alt="">
							...
							<div class="col-sm-6 m-b-20">
								<div class="invoice-details">
									...
									<ul class="list-unstyled">
										<li>Salary Month: <span>September, 2021</span></li>
									</ul>
								</div>
							</div>
						</div>
