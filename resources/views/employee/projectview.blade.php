    ...
    <div class="page-header">
		<div class="row align-items-center">
			...
			<div class="col-auto float-right ml-auto">
				<a href="{{route('projects')}}" class="btn add-btn" style="min-width: 90px;">Back</a>
			</div>
		</div>
	</div>
				...
				<div class="card-body">
					...
					<table class="table table-striped table-border">
						<tbody>
							...
							<tr>
								<td>Deadline:</td>
								<td class="text-right">{{ \Carbon\Carbon::parse($projectview->enddate)->isoFormat('MMM Do YYYY')}}</td>
							</tr>
							<tr>
								<td>Priority:</td>
								<td class="text-right">
